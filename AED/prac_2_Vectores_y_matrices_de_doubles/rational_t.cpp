...
{
  rational_t c;
  c.set_num( a.get_num()*b.get_den() + a.get_den()*b.get_num() );
  c.set_den( a.get_den() * b.get_den() );
  return c;
}
...
{
  rational_t c;
  c.set_num( a.get_num() * b.get_den() );
  c.set_den( a.get_den() * b.get_num() );
  return c;
}
