...
int main()
{
  ...
  // Fase Modificación
  cout << "¿Valor para pasarle al método GreaterThan de la clase SparsePolynomial (objeto 1)? (valor entero):\n";
  sp1.GreaterThan(8);
  cout << "¿Valor para pasarle al método GreaterThan de la clase SparsePolynomial (objeto 2)? (valor entero):\n";
  sp2.GreaterThan(8);
  cout << "¿Valor para pasarle al método GreaterThan de la clase SparsePolynomial (objeto 3)? (valor entero): \n";
  sp3.GreaterThan(8);
