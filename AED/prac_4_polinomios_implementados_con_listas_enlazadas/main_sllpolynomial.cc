...
int main() {
  ...
  // crear un metodo que devuelva la media de los dos últimos coeficientes del 
  // elemento polinomial invocado
  std::cout << "\nParte hecha en el aula como modificación:\n";
  // std::cout << "E-nesimos[a(n-1)+a(n)]/2=" << sllp3.Enesimo() << endl;
