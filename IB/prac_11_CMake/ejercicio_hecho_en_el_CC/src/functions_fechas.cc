...
void UserDates(int& argc, char* argv[]){
    ...
    for(auto actual_character: aux_var_vec_char) {
        ...
        user_day = aux_var_int;
            break;
        case 2:
        user_day = 10*user_day + aux_var_int;

        case 3:
        user_month = aux_var_int;
            break;
        case 4:
        user_month = 10*user_month + aux_var_int;

        case 5:
        user_year = aux_var_int;
            break;
        case 6:
        user_year = 10*user_year + aux_var_int;
    ...
    Dates actual_date(user_day, user_month, user_year);
